...
It prints a number like PROJJECT_NUMBER. Use it in the next two commands:
...
- At the end it prints your **Service URL**:
  ```
  Service URL: https://storyforge-backend-PROJJECT_NUMBER.asia-south1.run.app
  ```
...
```bash
curl https://storyforge-backend-PROJJECT_NUMBER.asia-south1.run.app/health
```
...
4. Before clicking Deploy, open **"Environment Variables"** and add:
   ...
   - **Value:** `https://storyforge-backend-PROJECT_NUMBER.asia-south1.run.app`
5. Click **Deploy**
...
|       What       | Command / URL                                                                                    |
| :--------------: | ------------------------------------------------------------------------------------------------ |
|   Backend URL   | `https://storyforge-backend-PROJECT_NUMBER.asia-south1.run.app`                                |
|   Health check   | `https://storyforge-backend-PROJECT_NUMBER.asia-south1.run.app/health`                         |
